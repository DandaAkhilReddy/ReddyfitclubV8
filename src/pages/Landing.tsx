      ...
      <section className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button
              onClick={() => navigate('/signup')}
              className="bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-primary-700 transition flex items-center justify-center gap-2"
            >
              Start Free Trial
            ...
            <button
              onClick={() => navigate('/signup')}
              className="bg-white border-2 border-gray-300 text-gray-900 px-8 py-4 rounded-lg font-semibold text-lg hover:border-primary-600 transition"
            >
              View Pricing
            </button>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary-600 to-blue-600 rounded-2xl p-12 text-center text-white">
            ...
            <button
              onClick={() => navigate('/signup')}
              className="bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition flex items-center justify-center gap-2 mx-auto"
            >
              Start Free Trial
              <ArrowRight className="w-5 h-5" />
            </button>
